/*
  ...
  - The values [INVESTMENT8] on the enum `bank_account_type` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "bank_account_type_new" AS ENUM ('CHECKING', 'INVESTMENTS', 'CASH');
